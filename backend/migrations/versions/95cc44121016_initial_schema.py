...
Revision ID: 95cc44121016
Revises: 
Create Date: 2026-07-20 00:25:50.210107
...
def upgrade():
    ...
    with op.batch_alter_table('carts', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_carts_cart_token'), ['cart_token'], unique=True)
    ...
    sa.Column('url', sa.String(length=760), nullable=True),
    ...
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('external_source', 'external_product_id', name='uq_external_product'),
...
def downgrade():
    ...
    with op.batch_alter_table('carts', schema=None) as batch_op:
        ...
        batch_op.drop_index(batch_op.f('ix_carts_cart_token'))
