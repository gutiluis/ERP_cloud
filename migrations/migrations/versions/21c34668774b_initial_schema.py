...
def upgrade():
    ...
    with op.batch_alter_table("adminUsers", schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f("ix_adminUsers_admin_id"), ["admin_id"], unique=True
        )
        batch_op.create_index(batch_op.f("ix_adminUsers_email"), ["email"], unique=True)
        batch_op.create_index(
            batch_op.f("ix_adminUsers_username"), ["username"], unique=True
        )
    ...
    op.create_table(
        ...
        sa.Column(
            "customer_type",
            sa.Enum("BUSINESS", "INDIVIDUAL", name="customertype", native_enum=False),
    ...
    with op.batch_alter_table("customers", schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f("ix_customers_customer_email"), ["customer_email"], unique=True
        )
        batch_op.create_index(
    ...
    with op.batch_alter_table("carts", schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f("ix_carts_cart_token"), ["cart_token"], unique=True
        )
        batch_op.create_index(
            batch_op.f("ix_carts_customer_id"), ["customer_id"], unique=False
        )
    ...
    with op.batch_alter_table("products", schema=None) as batch_op:
        ...
        batch_op.create_index(
            batch_op.f("ix_products_product_id"), ["product_id"], unique=True
        )
    ...
    with op.batch_alter_table("orders", schema=None) as batch_op:
        batch_op.create_index(batch_op.f("ix_orders_cart_id"), ["cart_id"], unique=True)
    ...
    op.create_table(
        ...
        sa.Column(
            "is_external", sa.Boolean(), server_default=sa.text("0"), nullable=False
        ),
    ...
    with op.batch_alter_table("product_variants", schema=None) as batch_op:
        ...
        batch_op.create_index(
            batch_op.f("ix_product_variants_stripe_price_id"),
            ["stripe_price_id"],
            unique=False,
        )
        batch_op.create_index(
            batch_op.f("ix_product_variants_stripe_product_id"),
            ["stripe_product_id"],
            unique=False,
        )
    ...
    with op.batch_alter_table("cart_items", schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f("ix_cart_items_cart_id"), ["cart_id"], unique=False
        )
        batch_op.create_index(
            batch_op.f("ix_cart_items_product_id"), ["product_id"], unique=False
        )
        batch_op.create_index(
            batch_op.f("ix_cart_items_product_variant_id"),
            ["product_variant_id"],
            unique=False,
        )
    ...
    with op.batch_alter_table("invoices", schema=None) as batch_op:
        ...
        batch_op.create_index(
            "ix_invoice_customer_status", ["customer_id", "status"], unique=False
        )
        batch_op.create_index("ix_invoice_status", ["status"], unique=False)
        batch_op.create_index(
            batch_op.f("ix_invoices_currency"), ["currency"], unique=False
        )
        batch_op.create_index(
            batch_op.f("ix_invoices_invoice_id"), ["invoice_id"], unique=True
        )
        batch_op.create_index(
            batch_op.f("ix_invoices_order_id"), ["order_id"], unique=True
        )
    ...
    with op.batch_alter_table("invoice_items", schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f("ix_invoice_items_invoice_id"), ["invoice_id"], unique=False
        )
        batch_op.create_index(
            batch_op.f("ix_invoice_items_product_id"), ["product_id"], unique=False
        )
    ...
    op.create_table(
        ...
        sa.Column("tax_rate_percent", sa.Numeric(precision=7, scale=4), nullable=False),
    ...
    with op.batch_alter_table("payments", schema=None) as batch_op:
        ...
        batch_op.create_index(
            batch_op.f("ix_payments_public_payment_id"),
            ["public_payment_id"],
            unique=True,
        )
...
def downgrade():
    ...
    with op.batch_alter_table("cart_items", schema=None) as batch_op:
        batch_op.drop_index(batch_op.f("ix_cart_items_product_variant_id"))
